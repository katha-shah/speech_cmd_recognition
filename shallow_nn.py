...
def get_parameters():
    weights = {'w1': tf.Variable(tf.random_normal([NUM_MFCC_SAMPLES, 32])),
...
data = wave_data.get_train_test_data(parent_path=train_data_path, audio_classes=audio_classes)
...
with tf.Session() as sess:
    ...
    if train:
        ...
        # saver.save(sess, ckpt_dir + "/mnist_conv.ckpt")
